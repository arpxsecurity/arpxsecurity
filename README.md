...
I’m comfortable working with penetration testing, vulnerability assessment, network and application security, Linux systems, AWS cloud environments, and security automation using Python. Alongside security, I also have practical exposure to machine learning, deep learning, data analysis, and full-stack web development, which helps me understand systems end-to-end from both attack and defense perspectives.
